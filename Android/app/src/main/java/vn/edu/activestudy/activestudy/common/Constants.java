...
public class Constants {
    ...
    public static String URL_UPDATE_ACCOUNT_INFO = "/updateAccountInfo";
    public static String URL_LOGIN = "/mauthen/mapp/login";
    public static String URL_LOGOUT = "/mauthen/mapp/logout";
