...
public class DbDisableAcountDevice extends DbProcess {

	private final String accountID;

	private final String deviceID;

	public DbDisableAcountDevice(String accountID, String deviceID) {
	...
	public void execute(DbConnectionExtra conn) throws Exception {
		CallableStatement ctm = ((OracleConnection)conn).getStmDisableAcountDevice();
