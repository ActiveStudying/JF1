...
//                Categorys.changeCurrentCategory();
                ...
                rs.close();
                 ...
                 logger.error("DbActive UnSuccess, ResultSet is Null");
            }
        } catch (SQLException se) {
            logger.error("DbActive ErrorCode: " +se.getErrorCode() + " Error: " + se.getMessage() + " STACK: " + se);
        } finally {
//            try {
//                if (pStmt != null) {
//                    pStmt.close();
